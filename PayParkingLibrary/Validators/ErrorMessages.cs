namespace PayParkingLibrary.Validators
{
	public static class ErrorMessages
	{
		...
		public static readonly string DuplicateRegistrationNumber = $"Car with same registration number already in parking lot.\n\t{AdminContact}";

		// Possible issue with camera reader; can implement sending notification to parking administrator
		public static readonly string RegistrationNumberNotFound = $"Car registration number is not recognized.\n\t{AdminContact}";

		// Software issue; can implement sending notification to parking administrator
		public static readonly string InvalidTimestamps = $"We are facing some internal issues.\n\t{AdminContact}";
